...
console.log(chalk.yellowBright(`Unfortunately, Due to shortage of space we can invite only two people for dinner`));
// • Remove guests from your list one at a time until only two names remain in your list. Each time you pop a name from your list, print a message to that person letting them know you’re sorry you can’t invite them to dinner.
while (guest_lists.length > 2) {
    let not_invited = guest_lists.pop();
    console.log(chalk.bgRedBright(`Sorry ${not_invited}, We cannot invite you to the dinner.\n`));
}
